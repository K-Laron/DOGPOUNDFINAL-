...
const Icons = {
    ...
    /**
     * Get icon SVG with customizable size
     * @param {string} name - Icon name
     * @param {number} size - Icon size in pixels
     * @returns {string} - SVG markup
     */
    get(name, size = this.defaultSize) {
    ...
    library: {
        ...
        medical: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>',
